...
let monthName = prompt("Enter the name of month");
 switch(monthName){
   case "January":
     alert("The month of days are 31");
     break;
     case "Feburary":
     alert("The month of days are 28");
     break;
     case "March":
     alert("The month of days are 31");
     break;
     case "April":
     alert("The month of days are 30");
     break;
     case "may":
     alert("The month of days are 31");
     break;
...
*/
let salery = prompt("Enter a salery");
   switch(true){
     case salery <= 20000:
       ...
       alert("Your hand-in amount ${salery-taxAmount}");
       break;
       case salery > 50000:
...
/* 9. Weather app
  ...
  - If user says`C` alert`Wear a T-shirt`
  - If`rainy` alert`Don't forget to take your raincoat`
  - If`hot` alert`Get a hanky`
  - If`freezing` alert`Get your sweeter on`
  - Anything else should alert`Not a valid input`
*/
let wheather = prompt("What is wheather outside");
